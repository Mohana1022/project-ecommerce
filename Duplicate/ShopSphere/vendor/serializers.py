...
class VendorProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'id_number', 'id_proof_file', 'pan_card_file', 
            'gst_number', 'pan_number', 'pan_name',
...
class VendorOrderItemSerializer(serializers.ModelSerializer):
    ...
    delivery_agent = SimpleDeliveryAgentSerializer(source='order.delivery_agent', read_only=True)

    class Meta:
        from user.models import OrderItem
        model = OrderItem
        fields = ['id', 'order_id', 'order_number', 'product', 'quantity', 'price', 'status', 'date', 
                  'payment_method', 'customer_address', 'delivery_agent', 
